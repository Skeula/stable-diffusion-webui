                ...
                for category in ordered_ui_categories():
                    if category == "sampler":
                        ...
                        with FormRow():
                            ...
                            with gr.Column(elem_id="txt2img_size_toolbox", scale=1, elem_classes="dimensions-tools"):
                ...
                for category in ordered_ui_categories():
                    if category == "sampler":
                        ...
                        with FormRow():
                            ...
                            with gr.Column(elem_id="img2img_size_toolbox", scale=1, elem_classes="dimensions-tools"):
